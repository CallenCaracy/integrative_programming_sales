    ...
    return (
      <SheetPortal>
        ...
        >
          <div
            className={cn(
              "bg-primary-foreground rounded-[12px] w-full max-w-3xl shadow-lg flex flex-col gap-4 overflow-hidden"
            )}
          >
            {children}
  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        data-slot="sheet-content"
        className={cn(
          "bg-primary-foreground data-[state=open]:animate-in data-[state=closed]:animate-out fixed z-50 flex flex-col gap-4 shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
          side === "right" &&
